...
class FPN(nn.Module):
    def __init__(self, backbone_out_channels, norm_layer=None, **kwargs):
        """
...
class FPEM_FFM(nn.Module):
    def __init__(self, backbone_out_channels, norm_layer=None, **kwargs):
        ...
        self.out_conv = nn.Conv2d(in_channels=conv_out * 4, out_channels=result_num, kernel_size=1)
...
class FPEM(nn.Module):
    def __init__(self, in_channels=128, norm_layer=None):
        super().__init__()
        self.up_add1 = SeparableConv2d(in_channels, in_channels, 1, norm_layer)
        self.up_add2 = SeparableConv2d(in_channels, in_channels, 1, norm_layer)
        self.up_add3 = SeparableConv2d(in_channels, in_channels, 1, norm_layer)
        self.down_add1 = SeparableConv2d(in_channels, in_channels, 2, norm_layer)
        self.down_add2 = SeparableConv2d(in_channels, in_channels, 2, norm_layer)
        self.down_add3 = SeparableConv2d(in_channels, in_channels, 2, norm_layer)
